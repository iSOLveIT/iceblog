...
$(function () {
  $(".btn_like").bind("click", function () {
    var blog_slug = $(".btn_like").attr("id");
...
$(function () {
  $("#showComments").bind("click", function () {
    var btnShowComments = document.getElementById("showComments");
    var classShowComments = btnShowComments.getAttribute("class");
...
$(function () {
  $("#btnPostComment").bind("click", function () {
    var category = document.getElementById("btnPostComment").getAttribute("blog-category");
    var slug = document.getElementById("btnPostComment").getAttribute("slug");
    var topic = document.getElementById("btnPostComment").getAttribute("name");
    var url = `/${category}/${topic}/${slug}`;
    $.post(
      $SCRIPT_ROOT + url,
      {
      ...
      function (data) {
        if (data) {
          ...
          $("#comment-alert").fadeOut(10000, "linear");
...
$(function () {
  $("#btnSubscribe").bind("click", function () {
    var category = document.getElementById("btnSubscribe").getAttribute("blog-category");
    var slug = document.getElementById("btnSubscribe").getAttribute("slug");
    var topic = document.getElementById("btnSubscribe").getAttribute("name");
    var url = `/${category}/${topic}/${slug}`;
    $.post(
      $SCRIPT_ROOT + url,
